...
const ThemeProvider = (props: Props) => {
  ...
  const theme = useMemo(() => {
    ...
    //const coreTheme = deepmerge(mergedTheme(settings.mode || 'light', direction), newColorScheme)

    const coreTheme = deepmerge(mergedTheme(settings, settings.mode || 'light', direction), newColorScheme)
