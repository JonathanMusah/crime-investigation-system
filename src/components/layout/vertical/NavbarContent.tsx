...
// const NavbarContent = ({ userName }: { userName: string }) => {
//   return (
//     <div className={classnames(verticalLayoutClasses.navbarContent, 'flex items-center justify-between gap-4 w-full')}>
