        ...
        <Form onSubmit={handleSubmit(onSubmit)}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} container spacing={2} justifyContent='flex-end'>
              <Grid item>
                <Button variant='outlined' onClick={onClose} disabled={editOfficerMutation.isPending}>
                  Cancel
                </Button>
              </Grid>
              <Grid item>
                <Button variant='contained' type='submit' disabled={editOfficerMutation.isPending || !isDirty}>
                  {editOfficerMutation.isPending ? 'Saving Changes' : 'Save Changes'}
                  {editOfficerMutation.isPending && <Spinner />}
                </Button>
              </Grid>
            </Grid>
          </Grid>
